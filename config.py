...
HISTORY_RENDER_LIMIT = int(os.getenv("HISTORY_RENDER_LIMIT", "20"))
HISTORY_RETENTION_MAX_EVENTS = int(os.getenv("HISTORY_RETENTION_MAX_EVENTS", "150"))
HISTORY_RETENTION_DAYS = int(os.getenv("HISTORY_RETENTION_DAYS", "14"))
ALERT_RENDER_LIMIT = int(os.getenv("ALERT_RENDER_LIMIT", "20"))
ALERT_RETENTION_MAX_EVENTS = int(os.getenv("ALERT_RETENTION_MAX_EVENTS", "150"))
ALERT_RETENTION_DAYS = int(os.getenv("ALERT_RETENTION_DAYS", "14"))
